...
const riskStyles: { [key in RiskLevel]: { badge: string; text: string; border: string; icon: JSX.Element } } = {
    [RiskLevel.Low]: {
...
Generated by AI Misinformation Detector.
    ...
    return (
        <div className="relative bg-white dark:bg-slate-800/50 p-6 rounded-lg shadow-lg animate-fade-in space-y-8">
            ...
            {report.classification && <ClassificationDisplay classification={report.classification} />}
